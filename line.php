 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if($text == "เธอชื่อไรหรอจ๊ะ" ||$text == "ชื่อ"||$text == "ชื่ออะไร"||$text == "ชื่ออะไรครับ"||$text == "ชื่ออะไรคะ"||$text == "name"||$text == "What your name?"||$text == "หนูชื่ออะไรครับ"){
	   	...
	   	if($text == "ขอรหัสนิสิตหน่อยบอท" ||$text == "รหัส"||$text == "รหัสนิสิต"||$text == "รหัสนิสิตผู้สร้างบอท"){
